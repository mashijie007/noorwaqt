...
export const EN = {
 ...
 "docTitle": "NoorWaqt — Global Prayer Times Map, Hijri Calendar & Women’s Fiqh",
 "docDesc": "A live global prayer times map: Fajr, Dhuhr, Asr, Maghrib and Isha for 152 cities, computed in your own browser. NoorWaqt is a dual Hijri/Gregorian prayer app with a fiqh engine built for women’s worship — menstruation, postpartum and istihadah rulings — running entirely on your device.",
 ...
 "privacyWeb": "This map works the same way: all {n} cities are computed in your browser, and your location never leaves your device. The page still loads web fonts, and a visit counter if you allow one.",
 ...
 "consentManage": "Analytics settings",
 "navGuide": "Fiqh Guide",
 "guideTitle": "Can you pray on your period? Somebody has to write this down properly",
 "guideLead": "Menstruation, postpartum bleeding, istihadah, pregnancy — the rulings on prayer and fasting for these days are well documented, and almost nobody has laid them out in a form you can look something up in. Seven pages, one question each, every disagreement between the schools left standing as a disagreement, with the evidence cited.",
 "guideQ1": "Can you pray on your period, and do you make the prayers up?",
 "guideA1": "You do not pray, and you owe nothing afterwards — all four schools agree. The disputes are at the two seams.",
 "guideQ2": "Do period fasts have to be made up, and why fasts but not prayers?",
 "guideA2": "Fasts are made up, prayers are not. How long you have, and what happens if you miss the next Ramadan.",
 "guideQ3": "Can you read Qur'an on your period, or enter the masjid?",
 ...
 "shareSend": "Share image",
 "shareSave": "Save image",
 "shareLink": "Share link",
 "shareCopied": "Link copied",
 "liveCurrentTime": "Current Time",
 "liveNextPrayer": "Next Prayer",
 "liveToday": "Today",
 "liveQibla": "Qibla",
 "liveKmToMakkah": "{km} km to Makkah",
 "liveFasting": "Fasting",
 "liveNow": "NOW",
 "liveNext": "NEXT",
 "liveMethod": "Method",
 "liveToFajr": "{t} to Fajr",
 "liveToIftar": "{t} to Iftar",
